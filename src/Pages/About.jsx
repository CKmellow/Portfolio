...
const AboutPage = ({ totalProjects, totalCertificates }) => {
  useEffect(() => {
    AOS.init({ once: false });
  }, []);
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <span className="block mt-2 text-gray-200">Cyprian Njuguna Kamau</span>
            </h2>
            ...
            {/* Quote Section */}
            <div
              className="relative bg-gradient-to-br from-[#6366f1]/5 via-transparent to-[#a855f7]/5 border border-[#6366f1]/30 rounded-2xl p-4 my-6 backdrop-blur-md shadow-2xl"
              data-aos="fade-up"
