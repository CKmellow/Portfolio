  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      ...
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question or collaboration idea? Send me a message or connect
          with me through the options below.
        </p>
      </div>
      ...
      >
        <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <input
                  ...
                  className="w-full p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:ring-2 focus:ring-[#6366f1]/30"
                  required
                />
              </div>
              <div
              ...
              >
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:ring-2 focus:ring-[#6366f1]/30 h-[9.9rem]"
                  required
                />
              </div>
              <button
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 flex flex-col justify-between hover:shadow-[#6366f1]/10 transition-all duration-500">
            <h2 className="text-3xl font-bold mb-5 text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
              Connect With Me
            </h2>
            <p className="text-gray-400 mb-6">
              You can also reach me directly through email or follow me on my
              social platforms.
            </p>
            <div className="space-y-4 text-gray-300">
              <p>
                <strong>Email:</strong>{" "}
                <a
                  href="mailto:kamaucyprian12@gmail.com"
                  className="text-[#6366f1] hover:underline"
                >
                  kamaucyprian12@gmail.com
                </a>
              </p>
              <p>
