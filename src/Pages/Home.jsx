...
const WORDS = ["Full-Stack Developer", "AI Enthusiast", "Tech Innovator"];
const TECH_STACK = ["React", "JavaScript", "Node.js", "Python", "TailwindCSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/CKmellow/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/cyprian-kamau/" },
];
...
const Home = () => {
  ...
  return (
  <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-20 " id="Home">
